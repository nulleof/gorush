...
[![GoDoc](https://godoc.org/github.com/nulleof/gofight?status.svg)](https://godoc.org/github.com/nulleof/gofight) [![Build Status](https://travis-ci.org/nulleof/gofight.svg?branch=master)](https://travis-ci.org/nulleof/gofight) [![Coverage Status](https://coveralls.io/repos/github/nulleof/gofight/badge.svg?branch=master)](https://coveralls.io/github/nulleof/gofight?branch=master) [![Go Report Card](https://goreportcard.com/badge/github.com/nulleof/gofight)](https://goreportcard.com/report/github.com/nulleof/gofight) [![codebeat badge](https://codebeat.co/badges/4d8b58ae-67ec-469e-bde6-be3dd336b30d)](https://codebeat.co/projects/github-com-nulleof-gofight) [![codecov](https://codecov.io/gh/nulleof/gofight/branch/master/graph/badge.svg)](https://codecov.io/gh/nulleof/gofight)
...
```bash
$ go get gopkg.in/nulleof/gofight.v1
```

To import this package, add the following line to your code:

```go
import "gopkg.in/nulleof/gofight.v1"
```
...
Copyright 2016 Bo-Yi Wu [@nulleof](https://twitter.com/nulleof).
